...
public class MainActivitySliderHistorical extends AppCompatActivity {
...
//        temperatureSwitcher.setText(temperatures[pos % temperatures.length]);
        ...
        placeSwitcher.setInAnimation(MainActivitySliderHistorical.this, animV[0]);
        placeSwitcher.setOutAnimation(MainActivitySliderHistorical.this, animV[1]);
        placeSwitcher.setText(places[pos % places.length]);

        clockSwitcher.setInAnimation(MainActivitySliderHistorical.this, animV[0]);
        clockSwitcher.setOutAnimation(MainActivitySliderHistorical.this, animV[1]);
    ...
    private class TextViewFactory implements  ViewSwitcher.ViewFactory {
        ...
        public View makeView() {
            final TextView textView = new TextView(MainActivitySliderHistorical.this);
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
                textView.setTextAppearance(MainActivitySliderHistorical.this, styleId);
            } else {
    ...
    private class ImageViewFactory implements ViewSwitcher.ViewFactory {
        @Override
        public View makeView() {
            final ImageView imageView = new ImageView(MainActivitySliderHistorical.this);
            ...
            if (clickedPosition == activeCardPosition) {
                ...
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
                    ...
                    final ActivityOptions options = ActivityOptions
                            .makeSceneTransitionAnimation(MainActivitySliderHistorical.this, sharedView, "shared");
