...
import static com.iiitm.android.zaika_e_gwalior.R.id.textView;

public class Mainfood2Activity extends AppCompatActivity {
    ImageView imageView;
    TextView textView3,textView5,textView35,textView8,textView10,textView;
