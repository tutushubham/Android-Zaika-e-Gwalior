...
public class MovieAdapterhistorical extends RecyclerView.Adapter<MovieAdapterhistorical.MyViewHolder>
{
    List<Adapterhistorical> adapterhistoricalList;
    Context mcontext;
    MovieAdapterhistorical(List<Adapterhistorical> adapterhistoricalList,Context mcontext)
    {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new MyViewHolder(view,adapterhistoricalList,mcontext);
    }

    @Override
    public void onBindViewHolder(MyViewHolder holder, int position) {

        Adapterhistorical adapter = adapterhistoricalList.get(position);
    ...
    public  class  MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        List<Adapterhistorical> adapterhistoricalList;
        Context mcontext;
        public MyViewHolder(View itemView,List<Adapterhistorical> adapterhistoricalList,Context mcontext) {
            super(itemView);
            this.adapterhistoricalList=adapterhistoricalList;
            this.mcontext=mcontext;
